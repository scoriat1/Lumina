    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplatePresets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_Practices_PracticeId",
                        column: x => x.PracticeId,
                        principalTable: "Practices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TemplatePresetFields",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TemplatePresetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplatePresetFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplatePresetFields_TemplatePresets_TemplatePresetId",
                        column: x => x.TemplatePresetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SourcePresetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Templates_Practices_PracticeId",
                        column: x => x.PracticeId,
                        principalTable: "Practices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Invoices_Practices_PracticeId",
                        column: x => x.PracticeId,
                        principalTable: "Practices",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClientPackages_Practices_PracticeId",
                        column: x => x.PracticeId,
                        principalTable: "Practices",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_Practices_PracticeId",
                        column: x => x.PracticeId,
                        principalTable: "Practices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPackages_PracticeId_ClientId_PackageId",
                table: "ClientPackages",
                columns: new[] { "PracticeId", "ClientId", "PackageId" });

            migrationBuilder.CreateIndex(
                name: "IX_Clients_PracticeId_Name",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_PracticeId",
                table: "Packages",
                column: "PracticeId");

            migrationBuilder.CreateIndex(
                name: "IX_Providers_PracticeId_UserId",
                table: "Providers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionNotes_TemplateId",
                table: "SessionNotes",
                column: "TemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_PracticeId_Date",
                table: "Sessions",
                columns: new[] { "PracticeId", "Date" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateFields_TemplateId_SortOrder",
                table: "TemplateFields",
                columns: new[] { "TemplateId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_TemplatePresetFields_TemplatePresetId_SortOrder",
                table: "TemplatePresetFields",
                columns: new[] { "TemplatePresetId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_Templates_PracticeId_Name",
                table: "Templates",
                columns: new[] { "PracticeId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Templates_SourcePresetId",
                table: "Templates",
